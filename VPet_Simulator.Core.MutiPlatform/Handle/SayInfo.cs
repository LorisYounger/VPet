...
/// 增加父类 以便适应带有流式传输的说话
/// </summary>
/// 结构与 Windows 版 VPet-Simulator.Core/Handle/SayInfo.cs 保持一致, 只把
/// 消息内容的类型从 WPF 的 UIElement 换成 Avalonia 的 Control.
/// 刻意不与 Windows 版共享基类: 那会逼着 Windows 版把公开字段挪到跨程序集的
/// 基类上, 从而破坏已编译 MOD 的 ABI. 这几十行重复远比 ABI 风险划算.
