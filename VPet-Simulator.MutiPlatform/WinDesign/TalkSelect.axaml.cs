//跨平台: 原文复制自 VPet-Simulator.Windows/WinDesign/TalkSelect.xaml.cs; 只换了命名空间、收起工具栏、ToolTip 与 ComboBox.Text 三处
using LinePutScript;
...
namespace VPet_Simulator.MutiPlatform
{
    ...
    {// 使用新的选项方式的聊天框
        ...
        public void RelsSelect()
        {
            ...
            ToolTip.SetTip(PrograssUsed, "下次刷新剩余时间: {0:f1}分钟".Translate(min));
        }

        private void btn_Send_Click(object? sender, RoutedEventArgs e)
        {
            if (tbTalk.SelectedIndex == -1 || tbTalk.SelectedItem as string == "没有可以说的话".Translate() || textList.Count == 0)
            {
                return;
            }
