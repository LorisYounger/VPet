...
namespace VPet_Simulator.MutiPlatform
{
    ...
    /// </summary>
    /// 跨平台: 原文复制自 VPet-Simulator.Windows/MutiPlayer/winMPBetterBuy.xaml.cs; WindowX→VPetWindow, Switch→shell:Switch,
    /// Dispatcher.Invoke→Dispatcher.UIThread.Invoke, ActualHeight→Bounds.Height, 其余逐行相同 (与 winBetterBuy 的改法一致)
    public partial class winMPBetterBuy : VPetWindow
    {
